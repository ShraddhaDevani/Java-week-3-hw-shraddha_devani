 ...
 */
public class Programme_4_DaysInMonth {
    ...
    public static int getDaysInMonth(int month, int year) {
        ...
        switch (month) {
            ...
            case 10: //October
            case 12: //December
                System.out.println("The Month " + month + " has days : 31");
                return 31;
            case 4: //April
            case 6: //June
            case 9: //September
            case 11: //November
                System.out.println("The Month " + month + " has days : 30");
                return 30;
            case 2: // February
                if (isLeapYear(year)) {
                    System.out.println("The Month " + month + " has days : 29");
                } else {
                    System.out.println("The Month " + month + " has days : 28");
                }
